...
const About = () => {
  ...
  I primarily work with C++ and modern web technologies, and I have practical experience with the MERN stack — using React.js for frontend, Node.js and Express.js for backend, and MongoDB for database management.<br />
  ...
  Beyond coding, I enjoy understanding how tech can transform industries.<br />
